...
BinarySearchTree.prototype.inOrderEsc = function() {
  var result = [];
  var node = this.root;
  var traverse = function(node) {
...
BinarySearchTree.prototype.inOrderDesc = function() {
  var result = [];
  var node = this.root;
  var traverse = function(node) {
      node.right && traverse(node.right);
...
console.log('INORDER', bst2.inOrderEsc());
console.log('POSTORDER', bst2.inOrderDesc());
